  ...
  <div>
    <b-modal ref="modal-otp" hide-footer :title="title" :id="idPopup" size="medium">
      ...
      <div class="flex recipient-popup">
        <div class="col-sm-5">
          <image-select :image="selectImage" @loadImage="loadImage" :isNotChange="true"/>
        </div>
        <div class="col-sm-7">
          <form>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" v-model="productName" disabled/>
              </div>
            </div>
